import { c as createComponent, V as VALID_INPUT_FORMATS, $ as $$BaseLayout, a as $$Header, b as $$Footer } from './Footer_pFfB5kot.mjs';
import { c as renderElement, s as spreadAttributes, u as unescapeHTML, a as renderTemplate, d as removeBase, i as isRemotePath, e as unflatten, A as AstroError, U as UnknownContentCollectionError, o as object, f as date, g as array, R as RenderUndefinedEntryError, h as escape, j as string, p as prependForwardSlash, k as createHeadAndContent, r as renderComponent, m as maybeRenderHead, b as addAttribute, l as renderSlot } from './prerender_BXd3ENYn.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_D5-URG7K.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./Footer_pFfB5kot.mjs').then(n => n._);
...
const $$PostLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  const { title, description, date, author = "Team" } = Astro2.props;
  const formattedDate = date.toLocaleDateString("en-US", {
    year: "numeric",
    month: "long",
    day: "numeric"
  });
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": title, "description": description }, { "default": ($$result2) => renderTemplate`   ${maybeRenderHead()}<section class="bg-primary py-14 sm:py-16 lg:py-20"> <div class="mx-auto max-w-site px-4 sm:px-6"> <nav aria-label="Breadcrumb" class="mb-4"> <ol class="flex items-center gap-1.5 text-sm text-primary-fg/60"> <li><a href="/" class="transition-colors hover:text-primary-fg">Home</a></li> <li class="flex items-center gap-1.5"> <svg class="size-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path> </svg> <a href="/blog" class="transition-colors hover:text-primary-fg">Blog</a> </li> <li class="flex items-center gap-1.5"> <svg class="size-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path> </svg> <span aria-current="page" class="text-primary-fg">${title}</span> </li> </ol> </nav> <h1 class="font-heading text-h1 font-bold uppercase text-primary-fg">${title}</h1> <div class="mt-3 flex items-center gap-3 text-sm text-primary-fg/70"> <span>${author}</span> <span aria-hidden="true">&bull;</span> <time${addAttribute(date.toISOString(), "datetime")}>${formattedDate}</time> </div> </div> </section>  <section class="py-section"> <div class="mx-auto max-w-3xl px-4 sm:px-6"> <article class="prose prose-lg max-w-none prose-headings:font-heading prose-headings:uppercase prose-a:text-primary-light hover:prose-a:text-primary"> ${renderSlot($$result2, $$slots["default"])} </article> <div class="mt-10 border-t border-border pt-6"> <a href="/blog" class="inline-flex items-center gap-2 text-sm font-semibold text-primary transition-colors hover:text-primary-light"> <svg class="size-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16l-4-4m0 0l4-4m-4 4h18"></path> </svg>
Back to Blog
</a> </div> </div> </section> ${renderComponent($$result2, "CTA", $$CTA, {})}  `, "footer": ($$result2) => renderTemplate`${renderComponent($$result2, "Footer", $$Footer, { "slot": "footer" })}`, "header": ($$result2) => renderTemplate`${renderComponent($$result2, "Header", $$Header, { "slot": "header" })}` })}`;
}, "/home/by/work/ratur.by/src/layouts/PostLayout.astro", void 0);
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "PostLayout", $$PostLayout, { "title": post.data.title, "description": post.data.description, "date": post.data.date, "author": post.data.author }, { "default": async ($$result2) => renderTemplate` ${renderComponent($$result2, "Content", Content, {})} ` })}`;
}, "/home/by/work/ratur.by/src/pages/blog/[...slug].astro", void 0);

const $$file = "/home/by/work/ratur.by/src/pages/blog/[...slug].astro";
const $$url = "/blog/[...slug]";
...
export { _page as _, getCollection as g };
